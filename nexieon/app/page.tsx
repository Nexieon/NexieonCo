...
export default function Home() {
  ...
  return (
    <main>
      <div className="relative ">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
          <div className={"text-center "}>
            <div
              className={
                "text-7xl md:text-8xl lg:text-9xl font-bold p-2 fadeInAnim"
              }
            >
      ...
      <section className=" grid md:grid-cols-2 xl:grid-cols-3 gap-8 py-14 mx-auto w-[95%] px-6">
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center ">
          <svg
            viewBox="0 0 24 24"
            fill="#1360f0"
            height="3.5em"
          ...
          <h1 className="text-black text-4xl font-bold ">Fully Custom</h1>
          <p className="text-center mx-20 mt-5 text-black">
            Our solutions are entirely bespoke, encompassing every aspect from
            backend development to frontend design. Our mission is to empower
            you to truly make it your own.
          </p>
        </div>
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold ">SEO</h1>
          <p className="text-center mx-20 mt-5 text-black">
            Our websites is meticulously crafted with industry best practices to
            ensure high rankings on various search engines, resulting in boosts
            to web traffic.
          </p>
        </div>
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold ">Fast</h1>
          <p className="text-center mx-20 mt-5 text-black">
            We harness cutting-edge technology to construct lightning-fast
            websites, providing unparalleled user experiences.
          </p>
        </div>
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          <svg
          ...
          <h1 className="text-black text-4xl font-bold ">Cost Effective</h1>
          <p className="text-center mx-20 mt-5 text-black">
            We pride ourselves on offering all of our services at cost-effective
            and competitive prices, allowing you to concentrate on what truly
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold ">Analytics</h1>
          <p className="text-center mx-20 mt-5 text-black">
            Track your analytics and optimize your web performance with our
            advanced tools and expertise, empowering you to achieve peak digital
            efficiency.
          </p>
        </div>
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold">Hosting</h1>
          <p className="text-center mx-20 mt-5 text-black">
            We take care of everything, from seamless deployment and hosting to
            expertly integrating your site into the vast expanse of the internet
          </p>
        </div>
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold">Modern Design</h1>
          <p className="text-center mx-20 mt-5 text-black">
            We pride ourselves on building all of our websites with modern
            design practices, ensuring that your online presence exudes
            contemporary aesthetics and delivers an exceptional user experience.
          </p>
        </div>
        ...
        <div className="bg-lightmode-gray h-[20rem] rounded-xl flex flex-col justify-center items-center">
          ...
          <h1 className="text-black text-4xl font-bold">Owner dashboard</h1>
          <p className="text-center mx-20 mt-5 text-black">
            Our sites include a custom owner's dashboard, allowing you to update and track your site effortlessly.  
          </p>
        </div>

        <div className="bg-lightmode-gray h-[20rem] rounded flex flex-col justify-center items-center">
          <h1 className="text-black text-4xl font-bold">
            Explore more benefits
          </h1>
          <Link href="/about" className="btn-main mt-10">
            More benefits
          </Link>
        </div>
      </section>
